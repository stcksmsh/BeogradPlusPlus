...
.method public static a(Landroid/content/Context;Lcom/huawei/hms/support/account/request/AccountAuthParams;Ljava/lang/String;I)Landroid/content/Intent;
    ...
    const-string v0, "com.huawei.hms.account.signIn"

    goto :goto_0

    :cond_0
    const-string v0, "com.huawei.hms.jos.signIn"
    ...
    .line 4
    const-class v0, Lcom/huawei/hms/account/internal/ui/activity/AccountSignInHubActivity;

    invoke-virtual {v2, p0, v0}, Landroid/content/Intent;->setClass(Landroid/content/Context;Ljava/lang/Class;)Landroid/content/Intent;

    const-string v0, "AppTouchFlag"
    ...
    .line 8
    new-instance v0, Lcom/huawei/hms/hwid/b;

    invoke-direct {v0}, Lcom/huawei/hms/hwid/b;-><init>()V

    .line 9
    invoke-virtual {v0, p3}, Lcom/huawei/hms/common/internal/bean/AbstractCpClientInfo;->setAppId(Ljava/lang/String;)V

    .line 10
    invoke-virtual {v0, p0}, Lcom/huawei/hms/common/internal/bean/AbstractCpClientInfo;->setPackageName(Ljava/lang/String;)V

    const-wide/32 v3, 0x2fdfeec

    .line 11
    invoke-virtual {v0, v3, v4}, Lcom/huawei/hms/common/internal/bean/AbstractCpClientInfo;->setHmsSdkVersion(J)V

    .line 12
    invoke-virtual {v0, p2}, Lcom/huawei/hms/common/internal/bean/AbstractCpClientInfo;->setSubAppId(Ljava/lang/String;)V
    ...
    .line 15
    :try_start_0
    invoke-virtual {v0}, Lcom/huawei/hms/common/internal/bean/AbstractCpClientInfo;->toJson()Ljava/lang/String;
...
.method public static a(Landroid/content/Intent;)Lcom/huawei/hms/support/account/result/AccountAuthResult;
    ...
    const-string v0, "getSignInResultFromIntent"
