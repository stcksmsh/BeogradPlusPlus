...
.method public static a([B)Ljava/security/cert/X509Certificate;
    ...
    const-string v2, "Failed to get cert,CertificateException:"
...
.method public static a(Ljava/security/cert/X509Certificate;Ljava/util/List;)Z
    ...
    :goto_1
    const-string p1, "verify failed,Exception:"
    ...
    :goto_3
    const-string p1, "verifyCertChain Exception:"
...
.method public static a(Ljava/security/cert/X509Certificate;[B[B)Z
    ...
    :goto_0
    const-string p1, "failed checkSignature,Exception:"
    ...
    :cond_1
    :goto_1
    const-string p0, "checkSignature parameter is null"
...
.method public static b(Ljava/util/List;)Ljava/util/List;
    ...
    const-string p0, "base64 CertChain is null."
    ...
    invoke-static {v2}, Lcom/huawei/hms/feature/dynamic/f/e;->a(Ljava/lang/String;)Ljava/security/cert/X509Certificate;

    move-result-object v2

    if-nez v2, :cond_1

    const-string v2, "Failed to get cert from CertChain"
...
.method private static c(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 47
    .line 48
    const-string v1, "Failed to getCertChain,JSONException:"
