...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Lio/reactivex/internal/schedulers/s$c;->a:Ljava/util/concurrent/PriorityBlockingQueue;
    ...
    .line 15
    .line 16
    iput-object v0, p0, Lio/reactivex/internal/schedulers/s$c;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 22
    .line 23
    iput-object v0, p0, Lio/reactivex/internal/schedulers/s$c;->c:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/c;
    ...
    .line 16
    .line 17
    invoke-virtual {p0, p4, p2, p3}, Lio/reactivex/internal/schedulers/s$c;->e(Ljava/lang/Runnable;J)Lio/reactivex/disposables/c;
...
.method public final e(Ljava/lang/Runnable;J)Lio/reactivex/disposables/c;
    .locals 1

    .line 1
    iget-boolean v0, p0, Lio/reactivex/internal/schedulers/s$c;->d:Z
    ...
    .line 14
    iget-object p3, p0, Lio/reactivex/internal/schedulers/s$c;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 22
    .line 23
    iget-object p1, p0, Lio/reactivex/internal/schedulers/s$c;->a:Ljava/util/concurrent/PriorityBlockingQueue;
    ...
    .line 27
    .line 28
    iget-object p1, p0, Lio/reactivex/internal/schedulers/s$c;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1
    :goto_0
    iget-boolean p2, p0, Lio/reactivex/internal/schedulers/s$c;->d:Z
    ...
    .line 49
    :cond_2
    iget-object p2, p0, Lio/reactivex/internal/schedulers/s$c;->a:Ljava/util/concurrent/PriorityBlockingQueue;
    ...
    .line 58
    .line 59
    iget-object p2, p0, Lio/reactivex/internal/schedulers/s$c;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 71
    :cond_3
    iget-boolean p3, p2, Lio/reactivex/internal/schedulers/s$b;->d:Z
    ...
    .line 74
    .line 75
    iget-object p2, p2, Lio/reactivex/internal/schedulers/s$b;->a:Ljava/lang/Runnable;
...
.method public final g()V
    ...
    .line 2
    iput-boolean v0, p0, Lio/reactivex/internal/schedulers/s$c;->d:Z
