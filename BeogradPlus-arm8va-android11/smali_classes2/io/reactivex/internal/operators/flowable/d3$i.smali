...
.method public final c(Lorg/reactivestreams/d;)V
    ...
    .line 13
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/d3$i;->b:Ljava/util/concurrent/Callable;
    ...
    .line 20
    .line 21
    new-instance v4, Lio/reactivex/internal/operators/flowable/d3$j;

    .line 22
    .line 23
    invoke-direct {v4, v1}, Lio/reactivex/internal/operators/flowable/d3$j;-><init>(Lio/reactivex/internal/operators/flowable/d3$g;)V
    ...
    :cond_3
    :goto_2
    new-instance v0, Lio/reactivex/internal/operators/flowable/d3$d;

    .line 56
    .line 57
    invoke-direct {v0, v1, p1}, Lio/reactivex/internal/operators/flowable/d3$d;-><init>(Lio/reactivex/internal/operators/flowable/d3$j;Lorg/reactivestreams/d;)V
    ...
    .line 63
    :cond_4
    iget-object p1, v1, Lio/reactivex/internal/operators/flowable/d3$j;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 69
    check-cast v4, [Lio/reactivex/internal/operators/flowable/d3$d;

    .line 70
    .line 71
    sget-object v5, Lio/reactivex/internal/operators/flowable/d3$j;->i:[Lio/reactivex/internal/operators/flowable/d3$d;
    ...
    .line 103
    :goto_4
    invoke-virtual {v0}, Lio/reactivex/internal/operators/flowable/d3$d;->p()Z
    ...
    .line 108
    .line 109
    invoke-virtual {v1, v0}, Lio/reactivex/internal/operators/flowable/d3$j;->b(Lio/reactivex/internal/operators/flowable/d3$d;)V
    ...
    .line 113
    :cond_8
    invoke-virtual {v1}, Lio/reactivex/internal/operators/flowable/d3$j;->a()V

    .line 114
    .line 115
    .line 116
    iget-object p1, v1, Lio/reactivex/internal/operators/flowable/d3$j;->a:Lio/reactivex/internal/operators/flowable/d3$g;

    .line 117
    .line 118
    invoke-interface {p1, v0}, Lio/reactivex/internal/operators/flowable/d3$g;->f(Lio/reactivex/internal/operators/flowable/d3$d;)V
