.class public Landroidx/media/session/a;
...
.method public static a(Landroid/content/Context;J)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p0}, Landroidx/media/session/a;->c(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    .line 16
    :cond_0
    invoke-static {p0, v0, p1, p2}, Landroidx/media/session/a;->b(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    .locals 3
...
.method public static e(Landroid/support/v4/media/session/MediaSessionCompat;Landroid/content/Intent;)Landroid/view/KeyEvent;
    ...
    .line 33
    .line 34
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat;->a(Landroid/view/KeyEvent;)V
...
.method public final onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 24
    :cond_0
    invoke-static {p1, v1}, Landroidx/media/session/a;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    .line 38
    .line 39
    invoke-static {p1, p2}, Landroidx/core/view/accessibility/d;->m(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 48
    .line 49
    invoke-static {p1, v0}, Landroidx/media/session/a;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    .line 63
    new-instance v2, Landroidx/media/session/a$a;

    .line 64
    .line 65
    invoke-direct {v2, p1, p2, v1}, Landroidx/media/session/a$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 72
    .line 73
    iput-object p2, v2, Landroidx/media/session/a$a;->f:Landroid/support/v4/media/MediaBrowserCompat;
